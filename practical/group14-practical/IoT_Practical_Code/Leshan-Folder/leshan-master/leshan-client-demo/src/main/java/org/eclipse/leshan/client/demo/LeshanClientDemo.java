...
public class LeshanClientDemo {
    ...
    private static final int OBJECT_ID_LIGHT_DEVICE = 10250;
    private static final int OBJECT_ID_SENSOR_DEVICE = 10350;
    ...
    public static void main(final String[] args) {
        ...
        // Get server URI
        String serverURI; //"coap://192.168.56.1:8080";
        if (cl.hasOption("u")) {
            if (cl.hasOption("i"))
            ...
            if (cl.hasOption("i"))
                serverURI = "coaps://localhost:5684";  // previously: localhost instead of 0.0.0.0
            else
                serverURI = "coap://localhost:5683"; // same
        }
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort,
        ...
        initializer.setInstancesForObject(OBJECT_ID_LIGHT_DEVICE, new MyLight());
        initializer.setInstancesForObject(OBJECT_ID_SENSOR_DEVICE, new MySensor());
        List<LwM2mObjectEnabler> enablers = initializer.create(SECURITY, SERVER, DEVICE, LOCATION, OBJECT_ID_TEMPERATURE_SENSOR, OBJECT_ID_LIGHT_DEVICE, OBJECT_ID_SENSOR_DEVICE);
